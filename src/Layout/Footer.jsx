...
const Footer = () => {
  return (
    <div className="w-full h-[50vh] bg-black flex flex-col justify-between items-center text-white">
      ...
      <div className="flex">
        ...
        <div className="flex gap-2">
          <h1 className="text-8xl font-bold font-poppins">DESIGN COMMUNITY</h1>
