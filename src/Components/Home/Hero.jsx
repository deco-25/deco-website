      ...
      <div className="flex justify-center flex-col items-center gap-14 z-10">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="text-9xl font-bold leading-[100px]">
            <div className="flex ">
              ...
              <span className="min-w-[550px]" id="title-1">
                {HERO_TITLE[currIndex].firstPart}
              </span>
            </div>

            <div className="flex ">
              <span className="max-w-min text-red-500">Co</span>
              <span className="min-w-[550px]" id="title-2">
                {HERO_TITLE[currIndex].secondPart}
              </span>
            </div>
          </div>
        </div>
        <div>
          <div className="mt-10 min-w-[3px] min-h-[150px] bg-black overflow-hidden relative">
            <div
              className="min-w-full min-h-full bg-white absolute"
              id="falling-bar"
            ></div>
          </div>
        </div>
